...
def _minimax_reasoning_effort(reasoning_config: dict | None) -> str | None:
...
class MiniMaxProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        **context: Any,
        ...
        route. ``thinking`` controls the M3 mode; ``reasoning_effort`` is only
        sent for effort levels MiniMax accepts.
        """
        ...
        if reasoning_config is not None:
            ...
            effort = _minimax_reasoning_effort(reasoning_config)
